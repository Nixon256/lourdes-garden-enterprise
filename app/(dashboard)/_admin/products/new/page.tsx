                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <RichTextEditor
                                    ...
                                    onChange={(val) => setFormData({ ...formData, descriptionEn: val })}
                                    placeholder="Detailed product story in English..."
                                />
                            </div>

                            <div className="md:col-span-2">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Full Description (Tamil)
                                </label>
                                <RichTextEditor
                                    value={formData.descriptionTa}
                                    onChange={(val) => setFormData({ ...formData, descriptionTa: val })}
                                    placeholder="Detailed product story in Tamil..."
                                />
                            </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <RichTextEditor
                                    ...
                                    onChange={(val) => setFormData({ ...formData, descriptionHi: val })}
                                    placeholder="Detailed product story in Hindi..."
                                />
                            </div>
                        </div>
                    </div>
