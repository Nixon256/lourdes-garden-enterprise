        ...
        headers: [
          ...
          // ─ CVE-2025-55183 mitigation: strict-dynamic prevents injected script execution
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://res.cloudinary.com https://lh3.googleusercontent.com https://www.googletagmanager.com https://maps.gstatic.com https://*.googleapis.com",
              "connect-src 'self' https://*.neon.tech https://www.google-analytics.com https://region1.clarity.ms https://api.razorpay.com https://api.stripe.com https://maps.googleapis.com",
              "frame-src https://checkout.razorpay.com https://js.stripe.com https://www.google.com/maps/ https://maps.google.com/ https://google.com/maps/",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
