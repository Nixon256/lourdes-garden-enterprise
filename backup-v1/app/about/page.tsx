...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen transition-colors duration-300 arima-font">
            ...
            {/* Footer */}
            <footer className="bg-gray-900 dark:bg-black text-white py-12 text-center text-sm text-gray-500 transition-colors">
                <div className="flex items-center justify-center gap-2 mb-4">
                    <Leaf className="w-6 h-6 text-green-500" />
                    <span className="text-xl font-bold text-white">{language === 'ta' ? 'லூர்து கார்டன்' : 'Lourdes Garden'}</span>
                </div>
                <p>© 2025 {language === 'ta' ? 'லூர்து கார்டன்' : 'Lourdes Garden'}. {language === 'ta' ? 'அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.' : 'All rights reserved.'}</p>
            </footer>
        </div>
    )
}
